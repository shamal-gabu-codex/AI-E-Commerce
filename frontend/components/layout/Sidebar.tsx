...
import { Activity, AlertTriangle, BadgeCheck, Bell, Bot, Boxes, ChartNoAxesCombined, ChevronRight, FileText, Home, KeyRound, Loader2, LogOut, Package, ShoppingCart, Sparkles, Star, TestTube2, Truck, UserRound, X } from "lucide-react";
...
const items = [
  ...
  { group: "Intelligence", href: "/business-health", label: "Health Score", icon: Activity },
  { group: "Intelligence", href: "/restocking", label: "Smart Restocking", icon: Boxes },
  { group: "Intelligence", href: "/executive-summary", label: "Executive Summary", icon: FileText },
  { group: "Intelligence", href: "/simulation", label: "What-If Simulation", icon: TestTube2 },
  { group: "Intelligence", href: "/advisor", label: "AI Advisor", icon: Sparkles },
